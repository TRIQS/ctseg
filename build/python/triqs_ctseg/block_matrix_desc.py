...
# The module
module = module_(full_name = "triqs_ctseg.block_matrix", doc = "Block-diagonal matrix containers")

# Add here all includes beyond what is automatically included by the triqs modules
module.add_include("<mpi/vector.hpp>")
module.add_include("<mpi/string.hpp>")
module.add_include("<triqs_ctseg/block_matrix.hpp>")
...
module.add_include("<nda_py/nda_py.hpp>")

module.add_using("namespace triqs_ctseg")
...
c = class_(
        ...
        c_type_absolute = "triqs_ctseg::block_matrix<double>",
...
c = class_(
        ...
        c_type_absolute = "triqs_ctseg::block_matrix<std::complex<double>>",
