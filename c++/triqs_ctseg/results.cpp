...
namespace triqs_ctseg {
  ...
  void h5_write(h5::group h5group, std::string subgroup_name, results_t const &c) {
    ...
    h5_write(grp, "nn_static_errors", c.nn_static_errors);
    h5_write(grp, "state_hist_errors", c.state_hist_errors);
    ...
    h5_write(grp, "average_order_Delta_error", c.average_order_Delta_error);
    h5_write(grp, "pert_order_Jperp", c.pert_order_Jperp);
    h5_write(grp, "average_order_Jperp", c.average_order_Jperp);
    h5_write(grp, "average_order_Jperp_error", c.average_order_Jperp_error);
  ...
  void h5_read(h5::group h5group, std::string subgroup_name, results_t &c) {
    ...
    h5::try_read(grp, "nn_static_errors", c.nn_static_errors);
    h5::try_read(grp, "state_hist_errors", c.state_hist_errors);
    ...
    h5::try_read(grp, "average_order_Delta_error", c.average_order_Delta_error);
    h5_read(grp, "pert_order_Jperp", c.pert_order_Jperp);
    h5_read(grp, "average_order_Jperp", c.average_order_Jperp);
    h5::try_read(grp, "average_order_Jperp_error", c.average_order_Jperp_error);
