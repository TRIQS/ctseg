...
*/
class move_group_into_spin_segment2 {
  qmc_parameters *params;
  configuration *config;
  triqs::mc_tools::random_generator &RND;

  colored_const_iterator A_dn, B_up, A_up, B_dn, A_dn_new, B_up_new;
  qmc_time_t A_dn_tau, B_up_tau;
  bool tried_group;

public:
  move_group_into_spin_segment2(qmc_parameters *params_, configuration *config_,
