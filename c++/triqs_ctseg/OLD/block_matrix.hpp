// Copyright (c) 2015-2018 Commissariat à l'énergie atomique et aux énergies
// alternatives (CEA) Copyright (c) 2015-2018 Centre national de la recherche
// scientifique (CNRS) Copyright (c) 2016 Igor Krivenko Copyright (c) 2018-2020
// Simons Foundation
//
...
namespace triqs_ctseg {
  ...
  */
  template <typename T> struct block_matrix {
    ...
    static std::string hdf5_format() { return triqs::is_complex<T>::value ? "BlockMatrixComplex" : "BlockMatrix"; }
