...
struct qmc_parameters {
  ...
  int nfft_threshold;
#endif
  bool measure_g2w, measure_f2w, measure_g3w, measure_f3w, measure_ft,
      measure_fw, measure_fl;
  std::string fname_gammaw;

  qmc_parameters(int n_color_, double beta_, array<double, 2> U_,
...
#ifdef HAVE_NFFT
        nfft_threshold(p.nfft_threshold),
#endif
