...
if mpi.is_master_node():
  A = HDFArchive("ct_seg_single_bath_spinspin_move_move.out.h5",'w')
  A['G_tau'] = S.G_tau
  A['F_tau'] = S.F_tau
...
h5diff("ct_seg_single_bath_spinspin_move_move.out.h5", "ct_seg_single_bath_spinspin_move_move.ref.h5")
