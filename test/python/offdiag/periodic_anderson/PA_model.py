...
n_tau =  10000
#fit_start =  Beta*2 
fit_start =  3.14*NFreqMatsubara/Beta
#fit_interval = Beta*2 
fit_interval = 2*3.14*NFreqMatsubara/Beta 
...
S = Solver(beta=Beta,n_iw = NFreqMatsubara, n_tau = n_tau, gf_struct = gf_struct)
