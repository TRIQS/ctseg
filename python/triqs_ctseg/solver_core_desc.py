...
# The module
module = module_(full_name="solver_core",
                 doc=r"The python module for triqs_ctseg", app_name="triqs_ctseg_J")

# Imports
module.add_imports(*['triqs.gf', 'triqs.gf.meshes',
                   'triqs.operators', 'triqs.stat.histograms', 'h5._h5py'])
...
c.add_property(name="Delta_tau",
               getter=cfunction(
                   "block_gf_view<triqs::mesh::imtime> Delta_tau ()"),
