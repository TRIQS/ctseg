...
# Imports
module.add_imports(*['triqs.gfs', 'triqs.mesh', 'triqs.operators', 'h5._h5py'])
...
c.add_member(c_name = "g2w",
             c_type = "std::optional<block2_gf<prod<imfreq, imfreq>, tensor_valued<4>>>",
             read_only= True,
...
+-------------------------------+--------------------------------------+-----------------------------------------+-------------------------------------------------------------------------------------------------------------------+
| dlr_omega_max                 | double                               | 100                                     | DLR frequency cutoff                                                                                              |
+-------------------------------+--------------------------------------+-----------------------------------------+-------------------------------------------------------------------------------------------------------------------+
| dlr_epsilon                   | double                               | 1e-8                                    | DLR precision                                                                                                     |
+-------------------------------+--------------------------------------+-----------------------------------------+-------------------------------------------------------------------------------------------------------------------+
...
+-------------------------------+--------------------------------------+-----------------------------------------+-------------------------------------------------------------------------------------------------------------------+
| measure_g2w                   | bool                                 | false                                   | Whether to measure three-point correlation function (see measures/four_point)                                     |
+-------------------------------+--------------------------------------+-----------------------------------------+-------------------------------------------------------------------------------------------------------------------+
...
c.add_member(c_name = "dlr_omega_max",
             c_type = "double",
             initializer = """ 100 """,
             doc = r"""DLR frequency cutoff""")

c.add_member(c_name = "dlr_epsilon",
             c_type = "double",
             initializer = """ 1e-8 """,
             doc = r"""DLR precision""")
...
c.add_member(c_name = "measure_g2w",
             c_type = "bool",
             initializer = """ false """,
             doc = r"""Whether to measure three-point correlation function (see measures/four_point)""")
